...
def build_dataset_row(
    ...
    """
    Build the final dataset row with correct fields and order.
    """

    ts = timestamp or current_utc_iso()

    # Derive stress index using merged metrics
    stress = compute_stress_index(merged_metrics)

    # Centrality values for THIS service
    ...
    # Ensure all columns exist (if you add later, still safe)
